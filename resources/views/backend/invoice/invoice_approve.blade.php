                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <a href="{{ route('invoice.add') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i class="fas fa-list"> Pending Invoice List</i> </a> <br>  <br> 
                                    <table class="table table-dark" width="100%">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><p> E-Mail: <strong> {{ $payment['customer']['email'] }} </strong> </p></td>
