    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Invoice Add </h4><br><br>

                        <div class="row">
                            <div class="col-md-1">
                                <div class="md-3">
                                    <label for="example-text-input" class="form-label">Inv No</label>
                                    <input class="form-control example-date-input" value="{{ $invoice_no }}" type="text" name="invoice_no" id="invoice_no" readonly style="background-color: #ddd;">
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="md-3">
                                    ...
                                    <input class="form-control example-date-input" type="date" value="{{ $date }}" name="date" id="date">
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="md-3">
                                    ...
                                    <i class="btn btn-info btn-rounded waves-effect waves-light fas fa-plus-circle addeventmore"> Add More</i>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        @csrf
                            <table class="table-sm table-bordered" width="100%" style="border-color: #ddd;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="discount_amount" placeholder="Discount Amount" value="0" id="discount_amount" class="form-control estimated_amount" >
                                        </td>
                                    </tr>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <div>
                                        <textarea class="form-control" rows="3" placeholder="Write description here" name="description" id="description"></textarea>
                                    </div>
                                </div>
                            </div><br>
                            ...
                            <div class="row">
                                <div class="form-group col-md-3">
                                    ...
                                    <select id="paid_status" name="paid_status" class="form-select">
