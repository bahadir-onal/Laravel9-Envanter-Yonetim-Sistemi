                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-6 mt-4">
                                                        <address>
                                                            <strong>Bahadır Önal:</strong><br>
                                                            Inventory Management<br>
                                                            bahadironal3@email.com
                                                        </address>
                                                    </div>
                                                    ...
                                                    <div class="p-2">
                                                        <h3 class="font-size-16">
                                                            <strong>Daily Invoice Report
                                                                <span class="btn btn-info"> {{ date('Y-m-d',strtotime($start_date)) }} </span>
                                                                -
                                                                <span class="btn btn-success"> {{ date('Y-m-d',strtotime($end_date)) }} </span>
                                                            </strong>
                                                        </h3>
                                                    </div>
